...
module.exports = Christ = async (Christ, mek) => {
  ...
  body = (type === 'conversation' && mek.message.conversation.startsWith(prefix)) ? mek.message.conversation : (type == 'imageMessage') && mek.message.imageMessage.caption.startsWith(prefix) ? mek.message.imageMessage.caption : (type == 'videoMessage') && mek.message.videoMessage.caption.startsWi(prefix) ? mek.message.videoMessage.caption : (type == 'extendedTextMessage') && mek.message.extendedTextMessage.text.startsWith(prefix) ? mek.message.extendedTextMessage.text : ''
    ...
    const istoyah = zeetoyah.includes(sender)
//==========================================================≠=============//
			var ase = new Date();
...
if (!mek.key.fromMe && !isamel && !iszee && banChats === true) return
//==========================================================≠=============//
switch (command) {
    case 'menu':
    case 'help':
...
case 'covid':
            ...
            anu = await fetchJson(`https://zeetoyah-api.herokuapp.com/api/covidworld?apikey=${apikey}`,{method: 'get'})
            teks = `[ *INFO COVID DUNIA* ]\n\ntotal kasus : ${anu.result.totalCases} jiwa\nSembuh : ${anu.result.recovered} jiwa\nmeninggal : ${anu.result.deaths} jiwa\nkasus aktif : ${anu.result.activeCases} kasus\nkasus tertutup : ${anu.result.closedCases} kasus\ninfo ini di update : ${anu.result.lastUpdate}\n\n*${namabot}*`
              fakestatus(teks)
              break
case 'infogempa':

             anu = await fetchJson(`https://zeetoyah-api.herokuapp.com/api/infogempa?apikey=${apikey}`,{method: 'get'})
             teks = `[ *INFO GEMPA TERKINI* ]\n\nwaktu : ${anu.result.Waktu}\nlintang : ${anu.result.Lintang}\nbujur : ${anu.result.Bujur}\nmagnitudo : ${anu.result.Magnitudo}\nkedalaman : ${anu.result.Kedalaman}\nwilayah : ${anu.result.Wilayah}\n\n*${namabot}*`
             fakestatus(teks)
             break
